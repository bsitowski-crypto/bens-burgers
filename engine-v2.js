...
const ASSETS={
 bottomBun:'assets/game/bottom-bun.svg',
 topBun:'assets/game/top-bun.svg',
 pattyRaw:'assets/game/patty-raw.svg',
 pattyCooking:'assets/game/patty-cooking.svg',
 pattyCooked:'assets/game/patty-cooked.svg',
 pattyBurned:'assets/game/patty-burned.svg',
 baconRaw:'assets/bacon-raw.png',
 baconCooking:'assets/bacon-raw.png',
 baconCooked:'assets/bacon-crispy.png',
...
function grill(i,x,y,w,h){
 rr(x,y,w,h,12,'#202323','#777');
 for(let j=0;j<6;j++){ctx.fillStyle=j%2?'#3a3d3c':'#111';ctx.fillRect(x+j*w/6,y,w/12,h)}
...
function render(){
 ctx.clearRect(0,0,1600,420);hits.length=0;ctx.fillStyle='#121413';ctx.fillRect(0,0,1600,420);
 text('🔥 GRILL',28,34,26,'left');text('🍽️ ASSEMBLY',655,34,26,'left');
 grill(0,30,65,270,165);grill(1,315,65,270,165);
 bin('patty','PATTY','pattyRaw',32,278,240,112);bin('bacon','BACON','baconRaw',310,278,240,112);
 rr(650,58,725,332,16,'#b98857','#6c4b32');
 ctx.beginPath();ctx.ellipse(1040,322,260,55,0,0,Math.PI*2);ctx.fillStyle='#e9e9e9';ctx.fill();ctx.strokeStyle='#8d9090';ctx.lineWidth=4;ctx.stroke();
 ctx.beginPath();ctx.ellipse(1040,315,185,34,0,0,Math.PI*2);ctx.fillStyle='#fff';ctx.fill();
 burger();
 rr(1405,55,175,335,15,'#b9bfbd','#666');bunBin(1420,75,145,88);bin('cheese','CHEESE','cheese',1420,175,145,88);bin('sauce','SAUCE','sauce',1420,275,145,88);
}
